...
#Build the model
    ...
    #tmp = Conv2D(n_classes, (1, 1), activation='relu', kernel_initializer='he_normal', padding='same')(c9)
    #reshape = Reshape(( 256 * 256, 3), input_shape = ( 256, 256, 3))(tmp)
    #print "reshape shape:",reshape.shape

    #permute = Permute((2,1))(reshape)
    #print "permute shape:",permute.shape

    #outputs = Activation('softmax')(reshape)
